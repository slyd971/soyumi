    ...
    regions: [
      {
        ...
        items: [
          "🇫🇷 Deflower, Paris",
          "🇫🇷 La Sunday Groove, Paris",
          "🇫🇷 Twenty One, Paris",
          "🇫🇷 Casa D'Oro, Paris",
          "🇫🇷 Yugka, Paris",
          "🇫🇷 Monkey Pigalle, Paris",
          "🇫🇷 Beau Coco, Paris",
          "🇫🇷 Terraza Mikuna, Paris",
          "🇫🇷 Too Tac Tac, Paris",
          "🇫🇷 Libertalia, Paris",
          "🇫🇷 Nanie, Paris",
          "🇫🇷 Barbanegra, Paris",
  ...
  videos: {
    ...
    items: [
      ...
      },
      {
        ...
        poster: "/soyumi/videos/video-soyumi-4-poster.jpg",
      },
      {
        id: "soyumi-video-3",
        title: "Live clip 05",
        description: "An excerpt built around rhythm, transitions and room energy.",
        src: "/soyumi/videos/video-soyumi-5.mp4",
        poster: "/soyumi/videos/video-soyumi-5-poster.jpg",
      },
    ],
  },
  spotify: {
